...
echo "======================================="
REMOTE_PS="${REMOTE_PS}" BRANCH_PS="${BRANCH_PS}" /bin/bash -c 'source <(curl -fsSL https://raw.githubusercontent.com/${REMOTE_PS}/${BRANCH_PS}/MacOS/Components/Core/pre_install.sh)'
...
REMOTE_PS="${REMOTE_PS}" BRANCH_PS="${BRANCH_PS}" /bin/bash -c 'source <(curl -fsSL https://raw.githubusercontent.com/${REMOTE_PS}/${BRANCH_PS}/MacOS/Components/Python/install.sh)'

# Setup Python environment and packages
echo "Setting up Python environment and packages..."
REMOTE_PS="${REMOTE_PS}" BRANCH_PS="${BRANCH_PS}" /bin/bash -c 'source <(curl -fsSL https://raw.githubusercontent.com/${REMOTE_PS}/${BRANCH_PS}/MacOS/Components/Python/first_year_setup.sh)'
...
if [ "$SKIP_VSCODE_INSTALL" = true ]; then
    ...
    REMOTE_PS="${REMOTE_PS}" BRANCH_PS="${BRANCH_PS}" /bin/bash -c 'source <(curl -fsSL https://raw.githubusercontent.com/${REMOTE_PS}/${BRANCH_PS}/MacOS/Components/VSC/install.sh)'
fi
...
REMOTE_PS="${REMOTE_PS}" BRANCH_PS="${BRANCH_PS}" /bin/bash -c 'source <(curl -fsSL https://raw.githubusercontent.com/${REMOTE_PS}/${BRANCH_PS}/MacOS/Components/Core/post_install.sh)' 
echo ""
