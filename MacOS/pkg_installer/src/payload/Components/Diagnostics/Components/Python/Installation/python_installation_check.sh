...
if command -v python3 >/dev/null 2>&1; then
    ...
    echo "PASS python3: $python3_path ($python3_version)"
...
if command -v python >/dev/null 2>&1; then
    ...
    echo "PASS python: $python_path ($python_version)"
    installation_found=1
else
...
if command -v pip3 >/dev/null 2>&1; then
    ...
    echo "PASS pip3: $pip3_path (v$pip3_version)"
else
...
if command -v pip >/dev/null 2>&1; then
    ...
    echo "PASS pip: $pip_path (v$pip_version)"
else
...
if [ $installation_found -eq 0 ]; then
    ...
    echo "PASSED Python installation check complete - PASSED"
fi