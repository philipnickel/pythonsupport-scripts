...
/bin/bash -c "REMOTE_PS=philipnickel; BRANCH_PS=mac_devided; bash -c \"\$(curl -fsSL https://raw.githubusercontent.com/\$REMOTE_PS/pythonsupport-scripts/\$BRANCH_PS/AutoInstallMacOS_main.sh)\""
```
